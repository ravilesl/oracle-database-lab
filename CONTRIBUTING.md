...
## Branch naming - Conventional Names
<type>/<issueNumber>-<short-description>, e.g. feature/56-customer-search, fix/85- customer-email-validation
 
## Commit messages
This project follows Conventional Commits: <type>(scope): <description>
#Editar CONTRIBUTING.md añadiendo security a la lista de tipos.
